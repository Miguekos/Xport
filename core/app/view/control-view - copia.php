                            ...
                            <div class="box-body">
                                    <table class="table datatable table-bordered table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td data-toggle="modal" data-target="<?php echo "#".$alumn->id; ?>"><?php echo $alumn->name." ".$alumn->lastname; ?></td>                   
                                                    ...
                                                    <div style="" class="modal fade" id="<?php echo $alumn->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form id="form3" action="./?action=updateassistance" method="POST">        
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="" style="background-color: ; border-radius: 10px;">
                                                                            <div class="panel-body">
                                                                              ...
                                                                              <br>
                                                                              <h4><p class="text-center"><?php echo $alumn->name; ?></h4></p>
                                                                        ...
                                                                        <div class="" style="background-color: ; border-radius: 10px;">
                                                                            <div class="panel-body">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="hidden" name="nombre" value="<?php echo $alumn->name; ?>">
                                                                                    <input type="hidden" name="apellido" value="<?php echo $alumn->lastname; ?>">
                                                                                </div>
