...
if ($fact == $factP) {
    ...
    for($x = 1; $x <= count($_POST['totalitem']); $x++) {
            ...
            $guardar = "insert into ventas (id_factura, id_producto, nombre, categoria, cantidad, id_monto, total, estado, hora, atendido, id_user) values ('$factP','$id','$nombre','$categoria','$nu2','$nu1','$nu3','1','$date','$atendido','$id_user')";
            //echo $guardar;
